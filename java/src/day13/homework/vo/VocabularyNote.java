...
public class VocabularyNote {
	//멤버 변수
		...
		/**단어와 뜻이 주어지면 단어장에 추가하는 메서드  (단어 객체를 넘겨주는 경우)
		 * 없는 단어이면 새로 단어를 추가하고 1을 리턴 있는단어이면 -1
		...
		/**단어와 뜻이 주어지면 단어장에 추가하는 메서드 (단어와 뜻을 넘겨주는 경우 경우)
		 * 
		 ...
		 * 매개변수 : 산제할 단어 => String title
		 * 리턴타입 : 없음 => void
		 * 메서드명 : delete
		 */
		
		/**단어가 주어지면 단어장에 해당 단어를 출력하고 단어가 있는지 없는지를 알려주 메서드
		 * 매개변수 : 단어 = > String title
		 * 리턴타입 : void => boolean
		 * 메서드명 : search
		 */
