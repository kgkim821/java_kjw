...
public class ComparsionEx {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*문자열을 포함한 참조 변수들은 주로 equals 를 이용하여 같은지 다른지 판별
		 * 
		 */
		...
		//참조 변수가 == 나 != 를 쓰는 대표적인 경우는 null 과 비교해서 비었는지 안비었는지 확인 할 때만 사용
