...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//AccessModifier 클래스와 B 클래스는 같은 패키지에 있는 클래스
...
class A{
	 ...
	 * 매개변수 : 없음 ==> 이미 알고 있는 내 정보 num1 이기 때문에
	 * 리턴타입 : 없음 => void
	 * 메서드명 : print
	 */
	public void print () {
		//num1은 private이기 때문에 A클래스의 매서드에서 호출 될 수 있다.
		//이미 알고있는 내 정보를 활용하는 경우 매개변수로 전달받지 않아도 됨.
		System.out.println(num1);
	}
	//private 으로 된 num1 에 접근하기 위해서 getter 를 추가
	public int getNum1() {
		return num1;
	}
