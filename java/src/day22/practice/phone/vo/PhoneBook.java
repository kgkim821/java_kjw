...
public class PhoneBook {
	...
	public boolean updateNumber (String name, String number) {
		...
		//number 가 전화번호 패턴이 맞는지 확인하기 위해서
		//전화번호 패턴이 맞으면 전화번호 객체를 생성했을때 전화번호가 있고,
		//패턴이 맞지 않으면 빈 문자열이 있다.
		//name과 number를 이요하여 전화번호 객체를 생성하는 대신 checkNumber를 이용
