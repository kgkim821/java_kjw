...
class SmartPhone extends Phone{
	...
	public SmartPhone() {
		//부모클래스의 생성자가 호출
		//super()를 이요하여 부모클래스의 생성자를 직접호출하지 않으면
	...
	//@Override   
	public void call(String num,String num2) {
		super.call(num);
