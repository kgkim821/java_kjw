...
public class MathEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.abs(-1.2)); //-1.2 의 절대값
		System.out.println(Math.ceil(1.29)); // 1.29 의 소수점 첫번째 자리에서 올림
		System.out.println(Math.floor(1.29));//1.29의 소수점 첫번째 자리에서내림
		System.out.println(Math.round(1.29));//1.29의 소수점 첫번째 자리에서 반올림
		System.out.println(Math.pow(2,3));//2의 3제곱
		System.out.println(Math.random());// 0 이상 1미만의 난수
