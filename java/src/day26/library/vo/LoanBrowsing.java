...
public class LoanBrowsing implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5445711842757396120L;
	...
	private void calculateReturnDate(int loanPeriod) {
		...
		/*new Date() : 현재 시간을 date 객체로생성
		 * new Date(Long a) : 1970 년 1월 1일 0 시를 기준으로 a밀ㄹ초만큼 흐른 날짜
		 */
