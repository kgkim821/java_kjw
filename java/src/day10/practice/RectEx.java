...
public class RectEx {
	...
	public static void main(String[] args) {
	 ...
	 class Rect1{
		//멤버변수
		 /*
		  * 왼쪽 위의점 x좌표, 왼쪽 위의점 y 좌표
		  * 오른쪽 아래의 점 x 좌표, 오른쪽 아래 점 y좌표
		  */
		  ...
		  */
		 	public void print() {
		 		...
		 		System.out.println("RD point" + rightDownY + "," + rightDownY );
		 	}
		 	/**사각형을 이동시키는 메서드
		  ...
		  */
		 	 ...
		 	 */
		 		public void move(int x, int y) {
		 			...
		 			int dy = leftUp.getY() - y; //이동한 거리 		-10
		 			leftUp.move(x, y);
